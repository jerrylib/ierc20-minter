...
export const sendEthers = (reviver, amount = new BigNumber(10).pow(18).multipliedBy(10)) => {
  if (!BigNumber.isBigNumber(amount)) {
    return new Error('must be a bignumber.js object')
  }

  return hre.network.provider.send('hardhat_setBalance', [reviver, `0x${amount.toString(16)}`])
}
