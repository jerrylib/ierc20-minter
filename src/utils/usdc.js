...
export const mintUsdcByAddressInEth = async (
  reciver,
...
export const mintUsdcByAddressInBsc = async (
  reciver,
...
export const mintUsdcByAddressInMatic = async (
  reciver,
  amount = new BigNumber(10).pow(18)
) => {
  if (isEmpty(reciver)) return new BigNumber(0)
...
export const mintUsdcByAddress = async (amount, reciver, chainId) => {
