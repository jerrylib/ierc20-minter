...
export const mintUsdtByAddressInEth = async (reciver, amount = new BigNumber(10).pow(6)) => {
...
export const mintUsdtByAddressInBsc = async (reciver, amount = new BigNumber(10).pow(18)) => {
  if (isEmpty(reciver)) return new BigNumber(0)
...
export const mintUsdtByAddress = async (reciver, amount, chainId) => {
